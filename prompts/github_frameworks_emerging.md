...
python3 /home/simon/documents/ai-researcher/scripts/github_filter.py --mode emerging

This fetches recently created GitHub repos matching AI agent framework topics, filters out
already-handled repos (unchanged pushed_at or previously rejected), and includes a
readme_preview (first ~20 lines of README) for each candidate.
...
python3 /home/simon/documents/ai-researcher/scripts/github_filter.py --reject "owner/repo1" "owner/repo2" ...
